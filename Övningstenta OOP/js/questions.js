...
function Metoder() {
    ...
    console.log("Metoder");
    return [
        ["Vad är skillnaden mellan en metod och en funktion?", "En funktion är snabbare och effektivare.|En funktion kan hantera fler värden än en metod.|En funktion tar emot ett index och ett värde medan en metod bara tar emot ett värde.|Ingen skillnad, metod som metod."],
        ["Vad är skillnaden mellan en metod och en konstruktor?", "En konstruktor är snabbare och effektivare.|En konstruktor kan hantera fler värden än en metod.|En konstruktor tar emot ett index och ett värde medan en metod bara tar emot ett värde.|Constructorn körs automagiskt när man instansierar en klass, en metod kan anropas när som helst."],
        ["Vad är skillnaden mellan en metod och en property?", "En property är snabbare och effektivare.|En property kan hantera fler värden än en metod.|En property tar emot ett index och ett värde medan en metod bara tar emot ett värde.|Propertyn är egentligen två metoder i en :-P."],
        ["Vad är en inparameter", "En parameter som inte kan ändras i runtime.|En inparameter som kan ändras i runtime.|En metod tar bara emot en parameter.|En parameter som kan byta namn i runtime.|En parameter som skickas till en metod."],
        ["Vad är en outparameter", "En parameter som inte kan ändras i runtime.|En inparameter som kan ändras i runtime.|En metod tar bara emot en parameter.|En parameter som kan byta namn i runtime.|En parameter som skickas till en metod."],
    ];
}
